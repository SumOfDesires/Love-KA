...
watermark.innerHTML = `<span style="text-shadow: -1px 0.5px 0 #dd71d2ff, -2px 0px 0 #bd5895ff;">Love</span> <span style="color:gray; padding-left:2px; font-family: Arial, sans-serif; font-size:10px">${ver}</span>`;
...
handleInput(['questionSpoof', 'videoSpoof', 'showAnswers', 'nextRecomendation', 'repeatQuestion', 'minuteFarm', 'customBanner']);
